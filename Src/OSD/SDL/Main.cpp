...
Util::Config::Node DefaultConfig()
{
  ...
  // Common
  config.Set<std::string>("InputUIPause", "KEY_ALT+KEY_P", "Input", "", "");
  config.Set<std::string>("InputUISaveState", "KEY_F5", "Input", "", "");
  config.Set<std::string>("InputUIChangeSlot", "KEY_F6", "Input", "", "");
  config.Set<std::string>("InputUILoadState", "KEY_F7", "Input", "", "");
